...
class SecretNumberGame
  ...
  def greet(player_name)
    ...
    puts "Hello and welcome #{player_name} to Secret Number. Guess a number and see if you win! You have #{@guesses} guesses when you play." 
  end

  def created_by
     #Created_by is a string that includes your first and last name
     puts "This was created by #{@first_name} #{@last_name}"
  end
