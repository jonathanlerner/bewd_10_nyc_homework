...
class SecretNumberGame
  ...
  def greet(player_name)
    puts "Hello #{player_name} and welcome to the best game ever made! In this game you'll try to guess the same number that the computer is guessing! You'll have a total of #{@guesses} guesses. Guess wisely. Godspeed!" #Create a string to use as your greeting. It should include the player_name and the rules, with the number of guesses the player gets.
  end

  def created_by
    puts "This game was created by #{@first_name} #{@last_name}" #Created_by is a string that includes your first and last name
  end
