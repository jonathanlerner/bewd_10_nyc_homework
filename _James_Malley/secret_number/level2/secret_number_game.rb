...
class SecretNumberGame
  ...
  def ask_difficulty
     ...
     puts "Would you like to play on easy (1), medium (2), or man up and play on hard (3)?"
  ...
  def greet(player_name)
    ...
    guess = @guesses
    puts "Welcome #{player_name}! What number am I thinking of between 1 and 10? You have #{guess} guesses."
  end
  ...
  def created_by
    ...
    first = @first_name
    last = @last_name
    puts "Hi I'm #{first} motherfreaking #{last}."
  end
